...
import (
	...
	_diamondWalletHandler "github.com/rdwansch/Trivia-Cap/resources/diamond_wallet/delivery/http"
	...
	"github.com/rdwansch/Trivia-Cap/resources/quizes/usecase"
...
func main() {
	...
	quizzessReposioty := repository.NewQuizzesRepository(client, cnf)
	...
	quizzesUseCase := usecase.NewQuizzesUseCase(quizzessReposioty)
	
	//goroutine redis
	go avatarUseCase.ReDoAvatarRedis()
	go quizzesUseCase.ReDoQuizRedis()
	...
	_quizesHandler.NewQuizesHandler(app, quizzesUseCase)
